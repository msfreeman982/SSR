        ...
        <div className="grid grid-cols-2">
            <div>
                <div className="w-[411px]">
                    <div className="text-[18px] text-[#000000] mb-[23px] font-bold">Simulate your investment</div>
                    ...
                    <div className="mb-[18px]">
                        <div className="text-[16px] text-[#000000] font-normal mb-[15px]">
            ...
            <div>
                ...
                <p className="text-[14px] mb-[20px] text-[#585858]">
                    At the end of your investment of 0 years, the value of your investment of 0 CHF is estimated at:
                </p>
                ...
                <div className="text-[12px] text-[#585858]">
                    *These projections do not constitute a contractual commitment.
                </div>
                <div className="mt-[181px] text-center">
