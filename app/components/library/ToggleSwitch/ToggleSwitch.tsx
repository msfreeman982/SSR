...
const ToggleSwitch: React.FC<Props> = (props) => {
  ...
  return (
      <label className={style.toggle} >
        ...
        />
        <div style={stylesText} className={isOn? style.toggle__is_on: style.toggle__is_off}>{props.textIsOn}</div> 
        <div style={stylesText} className={isOn? style.toggle__is_off: style.toggle__is_on}>{props.textIsOff}</div> 
      </label>
  );
};
