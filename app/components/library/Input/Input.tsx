    ...
    return (
        <div className={containerInput}>
            <div className={`${containerInput}__description`}>
                <label className={`${containerInput}__label`} htmlFor={props.name} style={props.styleInput?.label}>
                    {props.name}
                </label>
                {props.info ? (
                    <span className={`${containerInput}__info`} style={props.styleInput?.info}>
                        {props.info}
                    </span>
                ) : null}
            </div>
            <InputOrTextArea
                ...
                onBlur={handleBlur}
            />
            {props.sublabel && <span className={'input__sublabel'}>CFH</span>}
